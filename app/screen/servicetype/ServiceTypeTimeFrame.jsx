...
export default function ServiceTypeTimeFrame() {
  ...
  const fetchAvailableDays = async () => {
    try {
      setLoading(true);
      const data = await getDoctorServiceDay(doctorServiceId);
      // console.log(data);
  ...
  const fetchServiceDetails = async (dayOfWeek, day) => {
    try {
      ...
      const data = await getDoctorServiceTimeFrame(doctorServiceId, dayOfWeek, day);
